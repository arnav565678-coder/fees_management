...
?>
<h2><center><u>Fees Information</u></h2>
...
<table class="table my-4" id="myTable" >
  <thead>
    <tr>
      ...
      <th scope="col">Tution Fee's</th>
      <th scope="col">Transportation Fee's</th>
      <th scope="col">Scholarship</th>
      <th scope="col">Total</th>
      <th scope="col">Fees Paid</th>
      <th scope="col">Fees Due</th>
      <th scope="col">Admission Number</th>
      <th scope="col">Date Of Deoposit</th>
...
$sql1="SELECT
*
scholarship.scholarship_amt,students1.name
FROM fees
JOIN scholarship
