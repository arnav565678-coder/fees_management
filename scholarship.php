...
?>
<h2><center><u>Scholarshp Details</u></h2>
...
$sql1="SELECT *,scholarship_amt,name FROM fees,scholarship,students1 where fees.adm_no=scholarship.adm_no AND Fees.adm_no=students1.adm_no";
